...
class Generator_Mask_UNet(nn.Module):
    def __init__(self, n_channels = 1, maps = False):
        super(Generator_Mask_UNet, self).__init__()
        # e (encoder)
        ...
        self.rep7 = UNetDown(512, 512, dropout=0.5, normalize=False)
        # d (decoder)
    ...
    def forward(self, x, m, maps=None):
        ...
        r6 = self.rep6(r5)
        r7 = self.rep7(r6)
        u1 = self.up1(d8, torch.cat([d7, r7],dim=1))
...
class Mask_PatchGAN_Discriminator(nn.Module):
    def __init__(self, n_channels=3):
        super(Mask_PatchGAN_Discriminator, self).__init__()
...
if __name__ == '__main__': 
    ...
    net = Generator_Mask_UNet(n_channels = 1, maps = True)
