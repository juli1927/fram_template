...
class Generator_Mask_R_UNet_bloque(nn.Module):
    def __init__(self, n_channels = 1, maps = False):
        super(Generator_Mask_R_UNet_bloque, self).__init__()
        # e (encoder)
...
class Mask_R_PatchGAN_Discriminator_bloque(nn.Module):
    def __init__(self, n_channels=3):
        super(Mask_R_PatchGAN_Discriminator_bloque, self).__init__()
...
if __name__ == '__main__': 
    ...
    net = Generator_Mask_R_UNet_bloque(n_channels = 1, maps = True)
